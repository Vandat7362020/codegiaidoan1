type TNhanVien = { id:number; ten:string; phone:string; phai:TGioiTinh; ghichu:string}
type TGioiTinh = string | boolean;
type TDiemDen = { id:number; tendiemden: string; ghichu:string;  }
type TDangHoc = TNhanVien; 
type TDuThuyen = { id:number;  ten:string;  diachi:string;  hinh:string; }
const diemden_arr:TDiemDen[] = [
...
export { TDuThuyen, TDangHoc, TNhanVien, TDiemDen, TGioiTinh}
